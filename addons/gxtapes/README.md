...
Independent Stremio addon for G_Xtapes.

- Manifest ID: `community.gxtapes`
- Resources: catalog, meta, stream
- Content type: movie
- Local run: `npm run dev --workspace addons/gxtapes`
- Local manifest: `http://localhost:7000/manifest.json`
- Shared deployment manifest: `https://DEPLOYED-HOST/gxtapes/manifest.json`
