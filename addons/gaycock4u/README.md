...
Independent Stremio addon for Gaycock4U.

- Manifest ID: `community.gaycock4u`
- Resources: catalog, meta, stream
- Content type: movie
- Local run: `npm run dev --workspace addons/gaycock4u`
- Local manifest: `http://localhost:7000/manifest.json`
- Shared deployment manifest: `https://DEPLOYED-HOST/gaycock4u/manifest.json`
