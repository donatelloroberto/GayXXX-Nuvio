...
Independent Stremio addon for GayKinkyPorn.

- Manifest ID: `community.gaykinkyporn`
- Resources: catalog, meta, stream
- Content type: movie
- Local run: `npm run dev --workspace addons/gaykinkyporn`
- Local manifest: `http://localhost:7000/manifest.json`
- Shared deployment manifest: `https://DEPLOYED-HOST/gaykinkyporn/manifest.json`
