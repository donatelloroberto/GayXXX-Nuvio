...
Independent Stremio addon for Gaypornhot.

- Manifest ID: `community.gaypornhot`
- Resources: catalog, meta, stream
- Content type: movie
- Local run: `npm run dev --workspace addons/gaypornhot`
- Local manifest: `http://localhost:7000/manifest.json`
- Shared deployment manifest: `https://DEPLOYED-HOST/gaypornhot/manifest.json`
