...
Independent Stremio addon for Gayxnow.

- Manifest ID: `community.videosxgays`
- Resources: catalog, meta, stream
- Content type: movie
- Local run: `npm run dev --workspace addons/videosxgays`
- Local manifest: `http://localhost:7000/manifest.json`
- Shared deployment manifest: `https://DEPLOYED-HOST/videosxgays/manifest.json`
