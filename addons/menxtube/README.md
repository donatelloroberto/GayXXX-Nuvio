...
Independent Stremio addon for MenXtube.

- Manifest ID: `community.menxtube`
- Resources: catalog, meta, stream
- Content type: movie
- Local run: `npm run dev --workspace addons/menxtube`
- Local manifest: `http://localhost:7000/manifest.json`
- Shared deployment manifest: `https://DEPLOYED-HOST/menxtube/manifest.json`
