/*
 * Nurgay — Nuvio local scraper
 * Converted from the CloudStream package Nurgay.
 * Original source domain: https://nurgay.to
...
var CONFIG = {"id":"nurgay","name":"Nurgay","baseUrl":"https://nurgay.to","origin":"https://nurgay.to","searchTemplates":["/?s=%q%&page=1"],"itemSelector":"article.loop-video","mode":"nurgay","supportedTypes":["movie"]};
