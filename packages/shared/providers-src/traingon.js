/*
 * Traingon — Nuvio local scraper
 * Converted from the CloudStream package Traingon.
 * Original source domain: https://traingon.top
...
var CONFIG = {"id":"traingon","name":"Traingon","baseUrl":"https://traingon.top","origin":"https://traingon.top","searchTemplates":["/search?q=%q%"],"itemSelector":"a.card, div.card","mode":"generic","supportedTypes":["movie"]};
