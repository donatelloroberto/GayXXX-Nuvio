/*
 * FxggxtOrg — Nuvio local scraper
 * Converted from the CloudStream package FxggxtOrg.
 * Original source domain: https://fxggxt.org
...
var CONFIG = {"id":"fxggxtorg","name":"FxggxtOrg","baseUrl":"https://fxggxt.org","origin":"https://fxggxt.org","searchTemplates":["/?s=%q%"],"itemSelector":"article.loop-video.thumb-block, article.loop-video","mode":"generic","supportedTypes":["movie"]};
